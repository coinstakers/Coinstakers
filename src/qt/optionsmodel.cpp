...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCoinstakersAmount"))
        settings.setValue("nAnonymizeCoinstakersAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCoinstakersAmount = settings.value("nAnonymizeCoinstakersAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCoinstakersAmount"))
        SoftSetArg("-anonymizeCoinstakersamount", settings.value("nAnonymizeCoinstakersAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCoinstakersAmount:
            nAnonymizeCoinstakersAmount = value.toInt();
            settings.setValue("nAnonymizeCoinstakersAmount", nAnonymizeCoinstakersAmount);
            emit anonymizeCoinstakersAmountChanged(nAnonymizeCoinstakersAmount);
            break;
        default:
            break;
        }
