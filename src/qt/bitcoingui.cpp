...
{
    resize(850+95, 550);
    setWindowTitle(tr("Coinstakers") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Coinstakers address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show Coinstakers Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Coinstakers"), this);
    aboutAction->setToolTip(tr("Show information about Coinstakers"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Coinstakers"));
...
void BitcoinGUI::createToolBars()
{
    ...
    //menuAction->setToolTip(tr("Access Coinstakers Wallet Tabs"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Coinstakers client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Coinstakers client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Coinstakers network", "", count));
}
...
{
    QString strTitle = tr("Coinstakers") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Coinstakers address or malformed URI parameters."));
    }
