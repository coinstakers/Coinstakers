...
memory available when compiling CoinstakersCoin Core. With 512MB of memory or less
...
If you want to build Coinstakers-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a Coinstakers-qt executable will be
built by default.
