...
!define URL http://www.Coinstakers.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Coinstakers.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Coinstakers-qt.exe
...
OutFile Coinstakers-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Coinstakers-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Coinstakersd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Coinstakers.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Coinstakers-qt.exe
